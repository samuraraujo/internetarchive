...
class ConnectionPool
  ...
  def ConnectionPool.add_data_source(connection_params )
    ...
    begin
      void_source =  adapter.query(Query.new.distinct(:o).where(:s,RDFS::Resource.new('<http://xmlns.com/foaf/0.1/homepage>') ,:o).where(:s,RDF::type,RDFS::Resource.new('<http://rdfs.org/ns/void#Dataset>'))).uniq
